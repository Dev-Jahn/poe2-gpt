...
| MCP-006 | P0 | 스냅샷·사용자 변경·추천 실행 상태의 revision 관리 | MCP-006-T01, MCP-006-T02, MCP-006-T03 | Partial: revision-locked decision lifecycle; observations pending |
...
| MCP-010 | P1 | 새 소켓과 보조젬 포트폴리오 비교 | MCP-010-T01, MCP-010-T02, MCP-010-T03 | Partial: native gem requirements catalog; support portfolio pending |
| MCP-011 | P1 | 원본→변환 장비 비교와 미확정 롤 처리 | MCP-011-T01, MCP-011-T02, MCP-011-T03 | Pending |
| MCP-012 | P1 | 요구치·재장착·전환 순서 통합 solver | MCP-012-T01, MCP-012-T02, MCP-012-T03 | Pending |
...
| MCP-022 | P2 | 레벨업·전직·해금 milestone planner | MCP-022-T01, MCP-022-T02, MCP-022-T03 | Pending |
